    ...
    <section class="hero-section d-flex align-items-center bg-light" style="padding: 80px 0;">
        <div class="container mt-5 mb-5">
            <div class="col-md-6 mx-auto">
                ...
                <?php endif; ?>
                <form method="POST" action="/Himchistcka/register">
                    ...
                    <button type="submit" class="btn btn-outline-secondary btn-lg">Зарегистрироваться</button>
                    <p class="mt-3">Уже есть аккаунт? <a href="/Himchistcka/login">Войти здесь</a>.</p>
                </form>
            </div>
        </div>
    </section>
